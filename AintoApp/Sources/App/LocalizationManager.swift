...
final class LocalizationManager: ObservableObject {
    ...
    private static let english: [String: String] = [
        ...
        "search.application": "Application", "search.snippet": "Snippet: %@", "search.aiCommand": "AI Command", "search.manageAICommands": "Manage AI Commands", "search.command": "Command", "search.jsonSubtitle": "Format, minify, and query JSON", "search.openJSON": "Open JSON in JSON Formatter", "search.detectedJSON": "Detected JSON",
        ...
        "json.title": "JSON Formatter", "json.format": "Format", "json.minify": "Minify", "json.copy": "Copy", "json.clear": "Clear", "json.filter": "JS filter", "json.apply": "Apply", "json.emptyFilter": "Enter a filter expression", "json.openWindow": "Open in separate window", "json.close": "Close JSON editor"
    ]
    ...
    private static let simplifiedChinese: [String: String] = [
        ...
        "tray.hotkey": "快捷键", "tray.settings": "设置...", "tray.quit": "退出 Ainto",
        ...
        "json.title": "JSON 格式化", "json.format": "格式化", "json.minify": "压缩", "json.copy": "复制", "json.clear": "清空", "json.filter": "JS 过滤器", "json.apply": "应用", "json.emptyFilter": "请输入过滤表达式", "json.openWindow": "在独立窗口中打开", "json.close": "关闭 JSON 编辑器"
    ]
}
